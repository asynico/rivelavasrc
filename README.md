[![](https://img.shields.io/maven-metadata/v?metadataUrl=https%3A%2F%2Fmaven.asynico.wtf%2Freleases%2Fcom%2Fgithub%2Fasynico%2Frive-lavasrc%2Fmaven-metadata.xml)](https://maven.asynico.wtf/#/releases/com/github/asynico/rive-lavasrc)

# RiveLavaSrc

> [!IMPORTANT]
> For LavaSrc v3 (Lavaplayer v1 & Lavalink v3) look [here](https://github.com/asynico/RiveLavaSrc/tree/v3-legacy)
...
|-----------------------------------------------------|----------------|------------------------------|------------------------------------------------------------------------------------------------------------------------|
| Spotify                                             | 📁💿🎵🧑🔍🔬📜 | [Mirror](#what-is-mirroring) | [@asynico](https://github.com/asynico)                                                                                 |
| Apple Music                                         | 📁💿🎵🧑🔍🔬📜 | [Mirror](#what-is-mirroring) | [@asynico](https://github.com/asynico)                                                                               |
| Deezer                                              | 📁💿🎵🧑🔍🔬📜 | Direct                       | [@asynico](https://github.com/asynico)                                                                                 |
| Yandex                                              | 📁💿🎵🧑🔍🔬📜 | Direct                       | [@asynico](https://github.com/asynico)                                                                                 |
| Flowery TTS                                         |                | Direct                       | [@asynico](https://github.com/asynico)                                                                                 |
| YouTube (Music)                                     | 🔬📜           | N/A                          | [@asynico](https://github.com/asynico)                                                                                 |
| VK Music                                            | 📁💿🎵🧑🔍🔬📜 | Direct                       | [@asynico](https://github.com/asynico)                                                                                 |
| Tidal                                               | 📁💿🎵🧑       | [Mirror](#what-is-mirroring) | [@asynico](https://github.com/asynico)                                                                                 |
| Qobuz                                               | 📁💿🎵🧑       | Direct                       | [@asynico](https://github.com/asynico)                                                                                 |
| YouTube([yt-dlp](https://github.com/yt-dlp/yt-dlp)) | 📁💿🎵🧑🔍     | Direct                       | [@asynico](https://github.com/asynico)                                                                                 |
...
- 🧑 artist top tracks
- 🔍 search results
- 🔬 [LavaSearch](https://github.com/asynico/LavaSearch)
- 📜 [LavaLyrics](https://github.com/asynico/LavaLyrics)
...
lavalink:
  plugins:
    - dependency: "com.github.asynico.lavasrc:lavasrc-plugin:x.y.z"
      repository: "https://maven.asynico.wtf/releases" # this is optional for lavalink v4.0.0-beta.5 or greater
...
plugins:
  lavasrc:
    ...
    sources:
      ...
      youtube: false # Enable YouTube search source (https://github.com/asynico/LavaSearch)
...
#      clientSecret: "your client secret"
    ...
    yandexmusic:
      accessToken: "your access token" # the token used for accessing the yandex music api. See https://github.com/asynico/RiveLavaSrc#yandex-music
    ...
    vkmusic:
      userToken: "your user token" # This token is needed for authorization in the api. Guide: https://github.com/asynico/RiveLavaSrc#vk-music
    ...
    tidal:
      ...
      token: "your tidal token" # the token used for accessing the tidal api. See https://github.com/asynico/RiveLavaSrc#tidal
    qobuz:
      userOauthToken : "your user oauth token" # This token is needed for authorization in the api. Guide: https://github.com/asynico/RiveLavaSrc#qobuz
...
repositories {
  maven {
    url "https://maven.asynico.wtf/releases"
  }
}

dependencies {
  implementation "com.github.asynico.lavasrc:lavasrc:x.y.z"
  implementation "com.github.asynico.lavasrc:lavasrc-protocol:x.y.z"
}
```
...
<repositories>
  <repository>
    <id>Asynico-releases</id>
    <name>Asynico Maven Repo</name>
    <url>https://maven.asynico.wtf/releases</url>
  </repository>
</repositories>

<dependencies>
  <dependency>
    <groupId>com.github.asynico.lavasrc</groupId>
...
You can use a service such as [Spotify Tokener](https://github.com/asynico/spotify-tokener) via the `customTokenEndpoint` option to support those.
